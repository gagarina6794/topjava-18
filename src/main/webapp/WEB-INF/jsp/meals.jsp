    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="<%=request.getContextPath()%>/meals/mealForm?id=${meal.id}"><spring:message code="meal.update"/></a></td>
                <td><a href="<%=request.getContextPath()%>/meals/delete?id=${meal.id}"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
